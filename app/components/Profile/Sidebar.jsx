...
const Sidebar = () => {
  ...
  // -translate-x-full    in aside class
   return (
    <aside
      className="fixed md:block top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform 
    ...
    >
      ...
      <div
        className="flex absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full bg-white dark:bg-gray-800 z-20"
      >
        <a
          href="#"
