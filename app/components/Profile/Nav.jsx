...
const Nav = () => {
  ...
  const toggleDrawer = () => {
    ...
    let drawers = document.getElementById('drawer-navigation').style.display;
        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          >
           <svg
            ...
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white items-center">Lotto</span>
            </Link>
